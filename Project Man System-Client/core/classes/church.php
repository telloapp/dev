...
class Church{
	...
	public function update_church($id, $website, $name, $text, $email, $addr1, $addr2, $addr3, $addr4, $cell1, $cell2, $pastor, $pastor_site){
	...
	public function view_churchdata($id) {

		$query = $this->db->prepare("SELECT * FROM `church` WHERE `id`= ?");
		$query->bindValue(1, $id);
	 ...
	 public function delete_church($id) {
		...
		$query = $this->db->prepare("DELETE FROM church WHERE id = ?");
