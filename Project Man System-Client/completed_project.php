...
$show_completed_site = $client_project->view_completedsite();
...
<h1>list of completed Project</h1>
 ...
 <table width="100%" border="1" cellspacing="1" cellpadding="1">
                                ...
                                <th><a href="#">Aprrove Site</a></th>
                                <th><a href="revision.php?id=<?php echo $row['id'];?>">Unhappy</a></th>
