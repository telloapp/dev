...
$id = $_GET['id'];
$featuresIDobj = $client->view_features($id);
/*check feature id*/
...
<label class="" for="<?php echo $key['id']; ?>"><?php echo $key['pages']; ?>
	<a href="delete_features.php?feature_id=<?php echo $key['feature_id']?>&id=<?php echo $id;?>" onclick='return confirm("Are you sure you want to delete this feature?")'>&nbsp;Delete feature</a>
</label><br><br>
...
<input type="submit" name="submit" value="resent qoute request">
