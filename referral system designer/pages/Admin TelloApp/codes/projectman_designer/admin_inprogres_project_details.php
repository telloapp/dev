...
$inprogres_projects_details = $projects->admin_inprogres_projects_details($id);

$project_progress = $projects->admin_project_progress($id);
...
<br><br>
<a href="admin_inprogress_project.php?id=<?php echo "$id";?>" class="btn btn-success btn-md pull-right">Go Back</a><br><br> 
...
<?php }?>
                ...
                <h3 class="page-title">Inprogress Project Information</h3>                
                  <hr>
                             <div class="col-xs-12 noo-col">
                           
                              <?php foreach ($inprogres_projects_details as $row) { ?>
                             ...
                             <?php  } ?>
                              <br>
				                              ...
				                              Project Start Date:  <?php echo $row['date']; ?>
				                            </div>
								      Site Name    : 
