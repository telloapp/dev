...
$dt= date('Y-m-d');
 ...
 $inprogress_project = $projects->admin_inprogress_project();
...
<br><br>
                ...
                <h3 class="page-title">Project Information</h3>                
                  <hr>
                      ...
                      <a href="admin_inprogres_project_details.php?id=<?php echo $row['id']; ?>" class="btn btn-default btn-xs" ><i class="fa fa-trash">View Details</i></a>
