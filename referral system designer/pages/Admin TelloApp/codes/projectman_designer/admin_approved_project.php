...
$user_id  = htmlentities($user['id']); // storing the user's username after clearning for any html tags.
 ...
 $approved_project = $projects->approved_project();
?>
...
<br><br>
                ...
                <h3 class="page-title">Project Information</h3>                
                  <hr>
                      ...
                      <a href="admin_approved_project_details.php?id=<?php echo $row['id']; ?>" class="btn btn-default btn-xs" ><i class="fa fa-trash">View Details</i></a>
