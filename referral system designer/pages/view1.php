...
$show_all_uploads = $client_payment->all_uploaded_files($user_id,$c_id);
?>
<!DOCTYPE html>
...
<div id="body">
 <table width="80%" border="1">
    <tr>
    <th colspan="4">your uploads...<label><a href="index1.php?c_id=<?php echo "$c_id";?>">upload new files...</a></label></th>
    </tr>
    <tr>
    <td>File Name</td>
    <td>File Type</td>
