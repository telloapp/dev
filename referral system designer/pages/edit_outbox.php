...
$client->update_outbox($outboxid,$user_id,$website_type,$status,$origin,$site_name,$due_date,$no_of_pages,$facebook,$twitter,$instagram);
...
$client->save_outbox($user_id,$site_type,$status,$origin,$site_name,$due_date,$no_of_pages,$facebook,$twitter,$instagram);
