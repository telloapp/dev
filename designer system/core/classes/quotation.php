...
$query = $this->db->prepare("SELECT * FROM features t1 INNER JOIN selected_features t2 ON t1.id = t2.feature_id INNER JOIN site_data t3 ON t2.request_id = t3.id WHERE T3.id=?");
