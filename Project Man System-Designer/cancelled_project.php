...
$user_id  = htmlentities($user['id']); // storing the user's username after clearning for any html tags.
 ...
 $Cancelled_project = $projects->Cancelled_project($user_id);
?>
...
<br><br>
                ...
                <h3 class="page-title">Project Information</h3>                
                  <hr>
                      ...
                      <a href="cancelled_project_details.php?id=<?php echo $row['id']; ?>" class="btn btn-default btn-xs" i class="fa fa-trash">View Details</i></a>
