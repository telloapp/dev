      ...
      <div class="top-header">
        <div class="container">
          <div class="top-header-inner">
            <ul class="social-top">
              <li><a href="#" title="Facebook" target="_blank"><i style="background: #ef800a; color: #fff;" class="fa fa-facebook"></i></a></li>
              <li><a href="#" title="Twitter" target="_blank"><i style="background: #ef800a; color: #fff;" class="fa fa-twitter"></i></a></li>
              <li><a href="#" title="Pinterest" target="_blank"><i style="background: #ef800a; color: #fff;" class="fa fa-pinterest"></i></a></li>
              <!--li><a href="#" title="RSS" target="_blank"><i class="fa fa-rss"></i></a></li-->
            </ul>

            <div class="top-header-content">
              <div class="emailto content-item">
                <a href="mailto:info@afrilisting.com" style="color: #fff;"><i style="background: #ef800a; color: #fff;" class="fa fa-envelope-o"></i>&nbsp;Email:Teshla_car_insurance.com</a>
              </div>
              <div class="register content-item">
                <a href="register.php" style="color: #fff;"><i style="background: #ef800a; color: #fff;" class="fa fa-key"></i>&nbsp;Register</a>
              </div>
              <div class="login content-item">
                <a href="login.php" style="color: #fff;"><i style="background: #ef800a; color: #fff;" class="fa fa-sign-in"></i>&nbsp;User Login</a>
              </div>
        ...
        <div class="main-navigation">
          <nav class="collapse navbar-collapse" id="main-collapse" role="navigation">
            <ul class="nav navbar-nav">
              <li class="dropdown">
                <a href="index.php">Home Page&nbsp;<span class="caret"></span></a>
              ...
              <li class="dropdown">
                <a href="quotes.php">Gets Quotes&nbsp;<span class="caret"></span></a>
              </li> 
              ...
              <!--/li>
              <!--li class="dropdown">
                <a href="#">Cars&nbsp;<span class="caret"></span></a>
                <!--ul class="dropdown-menu dropdown-menu-right">
                  <li class="dropdown-submenu">
                    <a href="#">Blog</a>
                    <ul class="dropdown-menu dropdown-menu-right">
