      ...
      <!-- START COPYRIGHT -->
      <div class="copyright" style="background: #ef800a;">
        <div class="container">
          <div class="row">
            <div class="col-xs-12 col-sm-6 text-block" style="color: #fff;">
              &copy; <?php echo date("Y"); ?> Teshla.com All Rights Reserved.
              <br />
              <span style="color: #fff;">Powered by <a title="Akani Technologies" href="http://www.akani.co.za/" target="_blank" style="color: #fff;">Akani</a>.</span>
              <br>
            </div>
